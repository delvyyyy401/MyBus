        ...
        <div class="card-body">
          <form action="<?php echo base_url().'backend/order_mybus/inserttiket' ?>" method="post" enctype="multipart/form-data">
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="row form-group">
                    ...
                    <div class="col-sm-8">
                      <a href="<?php echo base_url('backend/konfirmasi_mybus/viewkonfirmasi/'.$tiket[0]['kd_order']) ?>" class="btn btn-secondary">Lihat</a>
                    </div>
                  </div>
                </div>
                <div class="col-sm-6">
              ...
              <?php if ($row['jumlah_kursi_institusi'] == 19) { ?>
                <hr><a class="btn btn-default" href="<?php echo base_url('backend/order_mybus/index2')?>">Kembali</a>
              <?php }else{ ?>
                <hr><a class="btn btn-default" href="<?php echo base_url('backend/order_mybus/index')?>">Kembali</a>
              <?php } ?>
