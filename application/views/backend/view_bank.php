    ...
    <div class="container-fluid">
      ...
      <div class="card shadow mb-4">
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-danger">Kode BANK [<?php echo $bank['kd_bank']; ?>]  </h6>
        </div>
        <div class="card-body">             
            <div class="card-body">
              <div class="row">
            ...
            <!-- <button data-toggle="modal" data-target="#edit" class="btn btn-danger pull-rigth">Edit No Rekening</button> -->
          </div>
      </div>
    </div>
  </div>
