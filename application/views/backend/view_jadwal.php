    ...
    <div class="container-fluid">
      ...
      <div class="card shadow mb-4">
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-danger">Kode Jadwal [<?php echo $jadwal['kd_jadwal']; ?>]  </h6>
        </div>
        <div class="card-body">             
            <div class="card-body">
              <div class="row">
            ...
            <button data-toggle="modal" data-target="#edit" class="btn btn-danger pull-rigth">Edit Harga</button>
          </div>
      </div>
    </div>
  </div>
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								<form action="<?php echo base_url('backend/jadwal_mybus/editharga') ?>" method="post" enctype="multipart/form-data">
									<div class="card-body">
										<div class="row">
											<div class="col-sm-14">                                              
                        <div class="row form-group">
                          <label class="">Harga Baru</label>
                          <input type="number" class="form-control" name="harga" value="<?php echo $jadwal['harga_jadwal']?>">
