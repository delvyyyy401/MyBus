...
use Mike42\Escpos\PrintConnectors\WindowsPrintConnector;
    ...
    $printer -> feed(1);      
        ...
        $printer -> text("Jl. Dr. Wahidin Sudirohusodo No.5-25\n");
        $printer -> text("Kotabaru - Gondokusuman\n");
        $printer -> text("Yogyakartan");
        $printer -> text("================================\n");
        ...
        $printer -> close();
    $printer -> close();
        redirect('tiket_mybus/tiketsaya/'.$cetak[0]['kd_pelanggan']);