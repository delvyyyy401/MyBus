    ...
    <div class="container-fluid">
      ...
      <div class="card shadow mb-4">
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-danger">Kode Rute [<?php echo $rute['kd_tujuan']; ?>]  </h6>
        </div>
        <div class="card-body">             
            <div class="card-body">
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <p>Nama Terminal   : <b><?php echo $rute['nama_terminal_tujuan']; ?></b></p>
                  <p>Nama Terminal   : <b><?php echo $rute['terminal_tujuan']; ?></b></p>
                </div>
                <div class="col-sm-6">
                </div>
            </div>
            ...
            <button data-toggle="modal" data-target="#edit" class="btn btn-danger pull-rigth">Edit Rute</button>
          </div>
      </div>
    </div>
  </div>
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								<form action="<?php echo base_url('backend/rute_mybus/editrute') ?>" method="post" enctype="multipart/form-data">
									<div class="card-body">
										<div class="row">
											<div class="col-sm-14">                                              
