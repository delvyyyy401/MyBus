    ...
    <div class="container-fluid">
      ...
      <div class="card shadow mb-4">
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-danger">KODE Order [<?php echo $konfirmasi[0]['kd_order']; ?>]  </h6>
        </div>
        <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="nama" value="<?php echo strtoupper($row['nama_bank_konfirmasi']) ?>" readonly>
                    </div>
                  </div>
                  <div class="row form-group">
