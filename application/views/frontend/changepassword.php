					...
					<div class="row d-flex justify-content-center">
						<div class="col-lg-6">
							...
							<div class="card" align="left">
								...
								<div class="card-body">
									<form ction="<?php echo base_url('profile_mybus/changepassword') ?>" method="post">
									...
									<a class="btn btn-secondary" href="<?php echo base_url() ?>profile_mybus/profilesaya/<?php echo $this->session->userdata('kd_pelanggan') ?>">Kembali</a>
									<button type="submit" class="btn btn-danger pull-right" >Ganti Password</button>
									</form>
								</div>
							</div>
						</div>
