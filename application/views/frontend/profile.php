								...
								<div class="card-body" align="left">
									<div class="row">
										...
										<div class="col-sm-14">
											...
											<p><a href="<?php echo base_url('profile_mybus/changepassword/'.$profile['kd_pelanggan']) ?>" class="btn btn-danger">Ganti Password</a></p>
											<p><button data-toggle="modal" data-target="#exampleModal" class="btn btn-danger">Edit Akun</button></p>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								<form action="<?php echo base_url('profile_mybus/editprofile') ?>" method="post" enctype="multipart/form-data">
									<div class="card-body">
										<div class="row">
											<div class="col-sm-14">
