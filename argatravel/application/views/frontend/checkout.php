					...
					<div class="col-lg-7">
					  ...
					  <div class="card-body" align="center">
					    ...
					    <p><img src="<?php echo base_url('assets/frontend/upload/qrcode/'.$tiket) ?>.png"></p>
					    	<a href="<?php echo base_url('assets/frontend/upload/qrcode/'.$tiket) ?>.png" class="btn btn-danger" download>Download QrCode</a> 
					    	<a href="<?php echo base_url('tiket_41518110070/payment/'.$tiket) ?>" class="btn btn-danger">Cek Pembayaran</a>
					    <br>
