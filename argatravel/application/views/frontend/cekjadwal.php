								...
								<table class="table table-striped">
									...
									<tbody>
										...
										<tr>
											...
											<td><a href="<?php echo base_url('tiket_41518110070/beforebeli/').$jadwal[$i]['kd_jadwal'].'/'.$asal['kd_tujuan'].'/'.$tanggal ?>" class=" btn btn-danger">Pilih</a></td>
										</tr>
										<?php } ?>
									</tbody>
								</table>
								</div>
								<a href="<?php echo base_url('_41518110070') ?>" class="btn btn-danger pull-left">Kembali </a>
									</div>
								</div>
							</div>
						</div>
